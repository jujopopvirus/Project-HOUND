...
var CODENAME : Array = [
	...
	"Hans", "Hansel", "Herala", "Hawk", "Ink", "Illo", "Igor", "Ijak", "Indi", "Joe", "Johnson", "Jordan", "John", "Jaye", "Jane", "Janitor", "Judas", "Juliet", "Kilo", "Korp", "Kardo", "Kito", "Khan", "Kidd", "Ligo", "Lea", "Lumi",    
...
@export var SPEED : int = RNG.randi_range(8, 14)
@export var ENDURANCE : int = RNG.randi_range(4, 30)
